...
export const siteConfig = {
  ...
  company: {
    ...
    description:
      "Rob Kielkucki founded Red Bridge Construction with a simple yet powerful mission: to deliver exceptional construction services across New Hope and Bucks County. For over 28 years we've been the trusted partner for homeowners and business owners who demand excellence in every detail.",
    foundedYear: 1997,
    yearsExperience: 28,
  ...
  services: [
    {
      ...
      description:
        "Expert home remodeling services in Bucks County, from custom kitchen renovations to complete home makeovers.",
      longDescription:
        "Transform your existing space with our premier home remodeling services. As trusted local contractors, we specialize in high-end kitchen and bath renovations, seamless home additions, and whole-house makeovers designed to increase your property's value and enhance your everyday lifestyle.",
      ...
      processSteps: [
        {
          title: "Discovery",
          description:
            "Walk the space together, capture priorities, set a realistic budget and timeline.",
        },
        {
          title: "Design",
          description:
            "Detailed drawings, finish selections, and a fixed-scope proposal with no surprises.",
        },
        {
          title: "Permitting",
          description:
            "We pull the permits and coordinate inspections across every Bucks County township.",
        },
        {
          title: "Build",
          description:
            "Daily site cleanliness, weekly progress updates, and a dedicated project lead on every job.",
        },
        {
          title: "Walkthrough",
          description:
            "Final punch list cleared before sign-off. One-year workmanship warranty included.",
        },
      ],
      faqs: [
        {
          q: "How long does a typical kitchen or bath remodel take?",
          a: "Most kitchens run 8–12 weeks from demo to final walkthrough; a full bath averages 4–6 weeks. We give you a written schedule at proposal and update it weekly.",
        },
        {
          q: "Do you handle design or do I need an architect?",
          a: "For most remodels we handle design in-house. For structural changes, additions, or whole-house projects we coordinate directly with a licensed architect.",
        },
        {
          q: "Can we stay in the home during the remodel?",
          a: "For single-room projects, yes. For whole-house renovations we'll talk you through dust isolation, water shut-offs, and whether a short stay elsewhere makes sense.",
        },
        {
          q: "Are you licensed and insured in Pennsylvania?",
          a: "Fully licensed PA Home Improvement Contractor, with general liability and workers' comp coverage. Certificates available on request.",
        },
      ],
      relatedProjectSlugs: [
        "gourmet-kitchen-remodel-new-hope",
        "master-bathroom-remodel-new-hope",
        "marble-mosaic-bathroom-doylestown",
      ],
    },
    {
      ...
      description:
        "Award-winning custom home builders bringing your dream property to life with unparalleled craftsmanship.",
      longDescription:
        "Build the house of your dreams with our comprehensive custom home building services. From the initial architectural design to the final walkthrough, we manage every phase of new construction. We prioritize energy efficiency, luxury materials, and flawless execution to deliver a move-in-ready masterpiece.",
      icon: "home",
      ...
      processSteps: [
        {
          title: "Lot & feasibility",
          description:
            "Site evaluation, zoning review, and budget framing before a single line is drawn.",
        },
        {
          title: "Architecture",
          description:
            "Schematic design through construction documents, paired with engineering and energy modeling.",
        },
        {
          title: "Pre-construction",
          description:
            "Fixed pricing, subcontractor bids, and a master schedule locked in before we break ground.",
        },
        {
          title: "Construction",
          description:
            "Single point of contact, on-site supervision, and weekly owner walkthroughs from foundation to finish.",
        },
        {
          title: "Move-in",
          description:
            "Punch list, systems orientation, and a one-year workmanship warranty with documented service intervals.",
        },
      ],
      faqs: [
        {
          q: "How long does a custom home take to build?",
          a: "From signed agreement to move-in, most projects run 12–18 months. Permitting in Bucks County townships typically accounts for 60–90 days of that.",
        },
        {
          q: "What does a custom build cost per square foot?",
          a: "Quality-tier builds in our region land between $350–$550/sf finished, depending on lot conditions, finishes, and mechanical systems. We provide a fixed-scope proposal before contract.",
        },
        {
          q: "Can we make changes during construction?",
          a: "Yes. Change orders are handled in writing with cost and schedule impact captured up front. There are no verbal-only changes.",
        },
        {
          q: "Do you build to high-performance standards?",
          a: "Every home is built tighter than code: continuous insulation, blower-door tested envelopes, and ENERGY STAR–grade mechanicals as standard.",
        },
      ],
    ...
    },
    {
      ...
      description:
        "Specialized historic home restoration preserving Bucks County's unique architectural heritage.",
      longDescription:
        "Protect and revive your historic property with our expert restoration services. We specialize in period-accurate historic preservation and structural repairs, seamlessly integrating modern amenities while strictly maintaining your home's original architectural integrity and timeless charm.",
      icon: "architecture",
      ...
      processSteps: [
        {
          ...
          description:
            "Building inspection by trade, covering framing, masonry, roofing, and mechanicals, with a documented findings report.",
        },
        {
          title: "Preservation plan",
          description:
            "Period-accurate scope of work, material specifications, and review against local historic district requirements.",
        },
        {
          title: "Structural stabilization",
          description:
            "Address settlement, rot, and load paths before any finish work begins.",
        },
        {
          title: "Restoration",
          description:
            "Replicate trim and millwork, conserve original masonry, and integrate modern mechanicals discreetly.",
        },
        {
          title: "Sign-off",
          description:
            "Final walkthrough, photographic record of hidden work, and one-year workmanship warranty.",
        },
      ],
      faqs: [
        {
          q: "Do you work on properties in historic districts?",
          a: "Yes. That includes review and submittal coordination with local Historic Architectural Review Boards across Bucks County.",
        },
        {
          q: "Can you replicate original trim and millwork?",
          a: "We profile and replicate period trim in primed cellular PVC or wood, and conserve original woodwork where it can be saved.",
        },
        {
          q: "How do you handle modern systems in a historic home?",
          a: "Mechanicals, electrical, and plumbing are run on routes that protect original framing and finishes. We document every concealed change.",
        },
        {
          q: "Is restoration more expensive than new construction?",
          a: "Per square foot, often yes, because structural surprises are common. We carry a contingency line item and report against it monthly.",
        },
      ],
      relatedProjectSlugs: [
        "historic-exterior-restoration-doylestown",
        "detached-garage-remodel-kintnersville",
      ],
    },
  ],
  ...
  portfolio: [
    {
      ...
      description:
        "Complete master bathroom renovation in New Hope, PA: replaced tilework, installed new frameless glass enclosure, updated plumbing fixtures in brushed brass, and added custom niche shelving for modern storage.",
      caseStudy: {
        ...
        clientGoal:
          "Transform a dated master bath into a spa-grade daily retreat with modern fixtures, generous niche storage, and a frameless walk-in shower, without disrupting the family's daily routine.",
        challenges: [
        ...
        solution:
          'Full demolition to studs, moisture-rated substrate replacement, plumbing re-run to current Bucks County code, fully bonded waterproofing membrane at pan and curb, solid-brass fixtures, custom mitered-edge niche shelving, and a frameless 3/8" glass enclosure.',
        results: [
        ...
        narrative: [
          "A New Hope homeowner came to Red Bridge Construction with a tired master bath. The tile was failing, the plumbing was undersized, and the glass enclosure had outlived its seal. The brief was direct: deliver a spa-grade retreat without compromising the daily rhythm of family life. From day one, safety, reliability, and lasting craftsmanship shaped every decision.",
          "The completed shower image in the gallery shows the result. A full-height tile field wraps a frameless 3/8\" glass enclosure, brushed-brass trim catches the morning light, and a mitered-edge niche replaces the leak-prone caddies the previous build relied on. Each visual detail traces back to a deliberate choice, from slip-resistant porcelain underfoot to niche placement set to the homeowner's reach and solid-brass fixtures specified over plated alternatives for two-decade durability.",
        ...
        metaDescription:
          "See how Red Bridge Construction crafted a spa-grade master bathroom remodel in New Hope, PA with frameless glass, brushed brass, and meticulous tile craftsmanship.",
        images: [
          {
            ...
            caption:
              "Final walkthrough with a full-height tile field, frameless glass, brushed-brass trim, and the custom mitered niche.",
          },
        ],
      },
    },
    {
      ...
      caseStudy: {
        ...
        clientGoal:
          "Elevate a builder-grade secondary bath into a designer-level space with a patterned marble feature wall, a floating vanity, and refined recessed lighting.",
        challenges: [
        ...
        metaDescription:
          "Red Bridge Construction transformed a Doylestown secondary bath into a marble-mosaic showpiece with floating vanity, LED lighting, and durable craftsmanship.",
        images: [
          {
    ...
    },
    {
      ...
      caseStudy: {
        ...
        clientGoal:
          "Convert a deteriorating detached structure into a fully insulated, electrified, four-season workshop on the original footprint, to comply with local zoning.",
        challenges: [
        ...
        metaDescription:
          "Red Bridge Construction rebuilt a failing Kintnersville outbuilding into an insulated, electrified four-season workshop with code-compliant craftsmanship in Bucks County.",
        images: [
          {
    ...
    },
    {
      ...
      caseStudy: {
        ...
        clientGoal:
          "Build a contemporary, light-filled custom home with floor-to-ceiling glass, open-plan living, and a seamless indoor-outdoor connection on a sloped, wooded lot.",
        challenges: [
        ...
        metaDescription:
          "See how Red Bridge Construction delivered a modern New Hope custom home with panoramic glass, steel-frame engineering, and on-schedule craftsmanship.",
        images: [
          {
            ...
            caption:
              "Signature elevation with triple-pane glazing, clean panel detailing, and a standing-seam roof line.",
          },
          {
            ...
            caption:
              "Entry detail with precision trim returns and concealed steel-moment-frame openings.",
          },
        ],
      },
    },
    {
      ...
      caseStudy: {
        ...
        clientGoal:
          "Restore an aging facade to period-accurate character while correcting structural settlement and dramatically improving curb appeal.",
        challenges: [
        ...
        metaDescription:
          "Red Bridge Construction restored a Doylestown home's exterior with period-accurate trim, corrected structural framing, and copper-clad craftsmanship in Bucks County.",
        images: [
          {
    ...
    },
    {
      ...
      caseStudy: {
        ...
        clientGoal:
          "Build a kitchen worthy of a serious home cook, with a marble waterfall island, custom plaster range hood, handcrafted open shelving, and an open-plan layout that hosts without losing prep space.",
        challenges: [
        ...
        metaDescription:
          "Red Bridge Construction built a chef-grade New Hope kitchen with a Calacatta-style waterfall island, custom plaster hood, and load-bearing wall craftsmanship.",
        images: [
          {
            ...
            caption:
              "Finished kitchen from the dining side with the waterfall island, custom plaster hood, and white-oak shelving.",
          },
        ],
      },
    },
  ...
  cta: {
    ...
    subheadline:
      "Experience matters. Our 28 years on the leading edge of building and renovation mean rock-solid project delivery and superior results.",
